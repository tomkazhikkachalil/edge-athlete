-- =====================================================
-- NOTIFICATION SYSTEM - FINAL SAFE SETUP
-- =====================================================
-- Works without likes/comments tables existing
...
-- (No foreign keys to non-existent tables)
-- =====================================================
...
BEGIN
  ...
  RAISE NOTICE '  ✓ 3 follow notification triggers';
  ...
  RAISE NOTICE '';
  RAISE NOTICE '╔════════════════════════════════════════════════╗';
  RAISE NOTICE '║          NEXT STEP: Enable Realtime           ║';
  RAISE NOTICE '╚════════════════════════════════════════════════╝';
  RAISE NOTICE '';
  RAISE NOTICE '1. Go to Supabase Dashboard';
  RAISE NOTICE '2. Database → Replication';
  RAISE NOTICE '3. Enable for "notifications" table';
  RAISE NOTICE '4. Save';
  RAISE NOTICE '';
