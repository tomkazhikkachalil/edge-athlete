...
-- =====================================================
-- This script drops the old notifications table and recreates it correctly
...
-- =====================================================
-- 6. CREATE UPDATE TRIGGER FOR NOTIFICATIONS
-- =====================================================
...
-- =====================================================
-- 7. CREATE HELPER FUNCTION TO CREATE NOTIFICATIONS
-- =====================================================
...
-- =====================================================
-- 8. CREATE TRIGGERS FOR AUTOMATIC NOTIFICATIONS
-- =====================================================
...
-- =====================================================
-- 9. CLEANUP FUNCTION FOR OLD NOTIFICATIONS
-- =====================================================
...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'notification_preferences') THEN
    RAISE NOTICE 'SUCCESS: notification_preferences table created';
  END IF;
END $$;
...
BEGIN
  ...
  RAISE NOTICE 'SUCCESS: % notification triggers created', v_trigger_count;
END $$;
