...
-- Drop existing policies if they exist (post_likes)
...
-- Drop existing policies if they exist (post_comments)
...
-- Add trigger for comments updated_at (assumes function exists)
