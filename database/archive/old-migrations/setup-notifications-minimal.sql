...
-- =====================================================
-- Only creates notifications for follows (which exists)
-- Likes and comments triggers can be added later
...
BEGIN
  SELECT COUNT(*) INTO v_trigger_count FROM pg_trigger WHERE tgname LIKE '%notify%';
  ...
  RAISE NOTICE '✓ % notification triggers created', v_trigger_count;
  RAISE NOTICE '✓ Follow notifications: ENABLED';
  RAISE NOTICE '✓ Like notifications: READY (waiting for likes table)';
  RAISE NOTICE '✓ Comment notifications: READY (waiting for comments table)';
  RAISE NOTICE '';
  RAISE NOTICE 'NEXT STEP: Enable Realtime in Supabase Dashboard';
  RAISE NOTICE 'Go to: Database → Replication → Enable for "notifications" table';
  RAISE NOTICE '==============================================';
END $$;
