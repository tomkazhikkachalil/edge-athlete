  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {isOpen && (
        <div
          role="listbox"
          className="absolute right-0 top-full mt-1 min-w-full w-max max-w-[80vw] bg-white border border-gray-200 rounded-lg shadow-lg z-20 max-h-60 overflow-y-auto py-1"
        >
          {[null, ...years].map(year => {
