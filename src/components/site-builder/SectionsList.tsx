...
// toast). The list never adds a section (Add section is the picker) and
// never edits a title or audience (the properties panel is a desktop aside —
// a later round).
...
export default function SectionsList({ site, layout, onCommit, onRemove }: Props) {
