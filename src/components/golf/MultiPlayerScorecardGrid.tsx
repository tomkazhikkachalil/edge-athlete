          ...
          {is18Holes && (
            <div className="flex border border-border-strong rounded-lg overflow-hidden">
              <button
                ...
                className={`relative after:absolute after:content-[''] after:-inset-y-1 after:inset-x-0 px-4 py-2 min-h-[36px] text-sm font-semibold transition-colors ${
                  activeTab === 'front9'
              ...
              <button
                ...
                className={`relative after:absolute after:content-[''] after:-inset-y-1 after:inset-x-0 px-4 py-2 min-h-[36px] text-sm font-semibold transition-colors border-l border-border-strong ${
                  activeTab === 'back9'
                    ? 'bg-green-600 text-white'
                    : 'bg-surface text-secondary hover:bg-surface-muted'
                }`}
