...
// ── /api/leagues/[id]/standings — the PUBLIC standings read (R3 spike) ──────
...
// Deliberately NO auth call at all: leagues are always public and this
...
export async function GET(
  ...
  try {
    ...
    reportRouteError('[STANDINGS] league GET error:', error);
