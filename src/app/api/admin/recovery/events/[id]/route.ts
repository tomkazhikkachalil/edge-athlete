...
import { cancelEvent, eventHost, makeEventPrivate, openRecovery, readEventPanel, removeCoOrganizer, type Result } from '@/lib/authority/recovery-server';
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const panel = await readEventPanel(getSupabaseAdmin(), id);
