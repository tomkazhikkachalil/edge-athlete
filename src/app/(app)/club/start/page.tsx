      ...
      <div className="min-h-screen bg-canvas">
        ...
        <div className="flex items-center justify-center py-20">
          <div className="text-center max-w-md mx-auto px-4">
            ...
            <h1 className="text-2xl font-bold text-primary mb-2">Create an account to start your club</h1>
            <p className="text-tertiary mb-6">
              Your club is live the moment you create it; directory listing is reviewed by an Edge Athlete admin.
            </p>
            {/* Phase 7 C1: park the intent both ways — ?next= for the plain
                sign-in, sessionStorage for the registration hard-reload. */}
            <Link
              href="/?next=%2Fclub%2Fstart%3Fsport%3Dgolf"
              onClick={() => {
                try { window.sessionStorage.setItem('ea:invite-return', '/club/start?sport=golf'); } catch { /* ignore */ }
              }}
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-tertiary">
            Your club is live the moment you create it — share the link, add members,
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="bg-surface rounded-xl border border-violet-300 shadow-sm p-5 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-tertiary mt-1">
                  Your club is live now; it joins the directory once an Edge Athlete admin approves the listing. One listing request can be open at a time.
                </p>
            ...
            <OrgStartWizard side="club" initialSport={initialSport ?? profile?.sport ?? null} onSubmitted={orgId => {
                if (orgId) router.push(`/app/org/club/${orgId}?welcome=1`);
