...
export const EVENT_COLUMNS =
  'id, host_profile_id, created_by_user_id, club_id, league_id, sport_key, name, description, cover_path, join_mode, visibility, link_token, format, status, capacity, format_config, self_entry, shape, competition_id, starts_on, opened_at, went_live_at, completed_at, cancelled_at, created_at, updated_at';
