...
const REVIEWED_SELF_SCOPED: Record<string, string> = {
  ...
  'clubs/[id]/roster': 'org-role system (club managers) + supervised-target 403 inside',
  'leagues/[id]/members': 'org-role system (league managers), not profile roles',
  'leagues/[id]/roster': 'org-role system (league managers) + supervised-target 403 inside',
