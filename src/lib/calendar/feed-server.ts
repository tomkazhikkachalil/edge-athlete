...
const FEED_EVENT_FIELDS =
  'id, title, description, location, starts_at, ends_at, all_day, timezone, status, updated_at, cancelled_at, org_id, org:organizations(kind), division_id, team_id, venue_id, facility_id';
