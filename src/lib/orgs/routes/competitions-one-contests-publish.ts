// ── One handler for both kinds (Round 5 E-2): the body of /api/{leagues,clubs}/[id]/competitions/[competitionId]/contests/publish ──
...
export async function competitionsOneContestsPublishRoutePOST(request: NextRequest, kind: OrgKind, params: { id: string; competitionId: string }) {
  try {
    ...
    reportRouteError(`[COMPETITIONS] ${kind} publish POST error:`, error);
