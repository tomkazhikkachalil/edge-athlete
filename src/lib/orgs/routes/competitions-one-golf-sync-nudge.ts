// ── One handler for both kinds (Round 5 E-2): the body of /api/{leagues,clubs}/[id]/competitions/[competitionId]/golf-sync/nudge ──
...
// ── /api/{leagues,clubs}/[id]/competitions/[competitionId]/golf-sync/nudge (phase 8 P5) ──
...
export async function competitionsOneGolfSyncNudgeRoutePOST(request: NextRequest, kind: OrgKind, params: { id: string; competitionId: string }) {
  try {
    ...
    reportRouteError(`[GOLF LEAGUE] ${kind} nudge error:`, error);
