...
describe('org-ref — the one spelling of how an org is named (Round 5 B)', () => {
  ...
  it('the pair is UNREAD outside an allowlist (step D0 — every other literal goes through org_id + the embed)', () => {
    ...
    const ALLOW: Record<string, number> = {
      ...
      'lib/org-sites/public-data.ts': 68,
      'lib/calendar/events.ts': 14,
      'lib/calendar/event-scope.ts': 18,
      'lib/calendar/series-server.ts': 10,
      'lib/calendar/detail-server.ts': 4,
      'lib/calendar/feed-server.ts': 2,
      'lib/calendar/org-merge-server.ts': 8,
      'lib/sport-events/validate.ts': 22,
      'lib/sport-events/view.ts': 6,
      'lib/sport-events/types.ts': 2,
      'lib/sport-events/contest-link.ts': 20,
      'lib/sport-events/contest-link-server.ts': 7,
      'lib/sport-events/contest-door-server.ts': 6,
      'lib/sport-events/access-server.ts': 2,
      'lib/sport-events/stat-results.ts': 4,
      ...
      'components/sport-events/CountsTowardWindow.tsx': 6,
      'components/sport-events/EventCreateWizard.tsx': 6,
      'app/api/calendar/events/route.ts': 6,
      'app/api/calendar/events/[id]/route.ts': 16,
      'app/api/calendar/events/[id]/respond/route.ts': 2,
      'app/api/sport-events/route.ts': 24,
      'app/api/sport-events/[id]/route.ts': 12,
      'app/api/admin/venues/route.ts': 2,
      'app/api/public/site-forms/[siteId]/[widgetId]/route.ts': 7,
