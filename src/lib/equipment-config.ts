...
export const EQUIPMENT_CATEGORIES: Record<string, EquipmentCategoryDef[]> = {
  golf: [
    { value: 'driver', label: 'Driver', icon: '🏌️', color: 'bg-blue-100 text-blue-700' },
    { value: 'fairway_wood', label: 'Fairway Wood', icon: '🌲', color: 'bg-green-100 text-green-700' },
    { value: 'hybrid', label: 'Hybrid', icon: '⚡', color: 'bg-purple-100 text-purple-700' },
    { value: 'iron_set', label: 'Iron Set', icon: '⛳', color: GRAY },
    { value: 'wedge', label: 'Wedge', icon: '🎯', color: 'bg-orange-100 text-orange-700' },
    { value: 'putter', label: 'Putter', icon: '⛳', color: 'bg-indigo-100 text-indigo-700' },
    { value: 'ball', label: 'Ball', icon: '⚪', color: 'bg-white text-gray-700 border border-gray-300' },
    { value: 'shoes', label: 'Shoes', icon: '👟', color: 'bg-red-100 text-red-700' },
    { value: 'glove', label: 'Glove', icon: '🧤', color: 'bg-yellow-100 text-yellow-700' },
    { value: 'bag', label: 'Bag', icon: '🎒', color: 'bg-teal-100 text-teal-700' },
    { value: 'rangefinder', label: 'Rangefinder', icon: '📏', color: 'bg-cyan-100 text-cyan-700' },
    { value: 'other', label: 'Other', icon: '🔧', color: GRAY },
  ],
  ice_hockey: [
    { value: 'stick', label: 'Stick', icon: '🏒', color: 'bg-blue-100 text-blue-700' },
    { value: 'skates', label: 'Skates', icon: '⛸️', color: 'bg-cyan-100 text-cyan-700' },
    { value: 'helmet', label: 'Helmet', icon: '🪖', color: 'bg-red-100 text-red-700' },
    { value: 'gloves', label: 'Gloves', icon: '🧤', color: 'bg-yellow-100 text-yellow-700' },
    { value: 'pads', label: 'Pads', icon: '🛡️', color: 'bg-orange-100 text-orange-700' },
    { value: 'jersey', label: 'Jersey', icon: '👕', color: 'bg-green-100 text-green-700' },
    { value: 'bag', label: 'Bag', icon: '🎒', color: 'bg-teal-100 text-teal-700' },
    { value: 'other', label: 'Other', icon: '🔧', color: GRAY },
  ],
  volleyball: [
    { value: 'shoes', label: 'Shoes', icon: '👟', color: 'bg-red-100 text-red-700' },
    { value: 'knee_pads', label: 'Knee Pads', icon: '🦵', color: 'bg-orange-100 text-orange-700' },
    { value: 'ball', label: 'Ball', icon: '🏐', color: 'bg-blue-100 text-blue-700' },
    { value: 'ankle_braces', label: 'Ankle Braces', icon: '🦶', color: 'bg-purple-100 text-purple-700' },
    { value: 'apparel', label: 'Apparel', icon: '👕', color: 'bg-green-100 text-green-700' },
    { value: 'bag', label: 'Bag', icon: '🎒', color: 'bg-teal-100 text-teal-700' },
    { value: 'other', label: 'Other', icon: '🔧', color: GRAY },
  ],
  basketball: [
    { value: 'shoes', label: 'Shoes', icon: '👟', color: 'bg-red-100 text-red-700' },
    { value: 'ball', label: 'Ball', icon: '🏀', color: 'bg-orange-100 text-orange-700' },
    { value: 'apparel', label: 'Apparel', icon: '👕', color: 'bg-green-100 text-green-700' },
    { value: 'accessories', label: 'Accessories', icon: '🎽', color: 'bg-purple-100 text-purple-700' },
    { value: 'bag', label: 'Bag', icon: '🎒', color: 'bg-teal-100 text-teal-700' },
    { value: 'other', label: 'Other', icon: '🔧', color: GRAY },
  ],
  soccer: [
    { value: 'cleats', label: 'Cleats', icon: '👟', color: 'bg-red-100 text-red-700' },
    { value: 'shin_guards', label: 'Shin Guards', icon: '🦵', color: 'bg-orange-100 text-orange-700' },
    { value: 'ball', label: 'Ball', icon: '⚽', color: 'bg-blue-100 text-blue-700' },
    { value: 'gloves', label: 'Goalkeeper Gloves', icon: '🧤', color: 'bg-yellow-100 text-yellow-700' },
    { value: 'apparel', label: 'Apparel', icon: '👕', color: 'bg-green-100 text-green-700' },
    { value: 'bag', label: 'Bag', icon: '🎒', color: 'bg-teal-100 text-teal-700' },
    { value: 'other', label: 'Other', icon: '🔧', color: GRAY },
  ],
  baseball: [
    { value: 'bat', label: 'Bat', icon: '🏏', color: 'bg-blue-100 text-blue-700' },
    { value: 'glove', label: 'Glove', icon: '🧤', color: 'bg-yellow-100 text-yellow-700' },
    { value: 'cleats', label: 'Cleats', icon: '👟', color: 'bg-red-100 text-red-700' },
    { value: 'helmet', label: 'Helmet', icon: '🪖', color: 'bg-orange-100 text-orange-700' },
    { value: 'batting_gloves', label: 'Batting Gloves', icon: '🤾', color: 'bg-purple-100 text-purple-700' },
    { value: 'bag', label: 'Bag', icon: '🎒', color: 'bg-teal-100 text-teal-700' },
    { value: 'other', label: 'Other', icon: '🔧', color: GRAY },
  ],
