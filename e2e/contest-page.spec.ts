...
/** A league (owner = QA user B, member = QA user A) with a public and a
 *  private fixture competition, each holding one completed contest. The
 *  caller deletes the league (cascades everything). */
async function seedLeague(): Promise<Seeded> {
